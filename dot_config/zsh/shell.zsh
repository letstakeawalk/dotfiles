...
alias chez=chezmoi
alias seshf=sesh-fzf
alias tf=sesh-fzf # mnemonic: tmux-fzy
...
alias gloga="git log --all --graph --oneline --decorate --date=short --pretty=format:'%C(magenta)%ad %C(auto)%h%d %s'"
