 ...
 *
 * Adapted from: https://github.com/affaan-m/everything-claude-code/blob/main/scripts/hooks/evaluate-session.js
 *
...
async function main() {
  ...
  const configFile = path.join(__dirname, "config", "evaluate-session.json");
