return {
    {
        ...
        config = function()
            ...
            -- floating popup
            -- dressing telescope cmp lsp_signature
            vim.api.nvim_set_hl(0, "Pmenu", { fg = nord.c04, bg = nord.c01 })
            vim.api.nvim_set_hl(0, "NormalFloat", { link = "Normal" })
            vim.api.nvim_set_hl(0, "FloatTitle", { fg = nord.c09 })
            vim.api.nvim_set_hl(0, "FloatBorder", { fg = nord.c03_br }) -- FloatBorder > WinSeparator > VertSplit
