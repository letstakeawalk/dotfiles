...
-- quickfix & loclist
set("n", "]x", u.qf.xnext, { desc = "Goto next qfloclist item" })
set("n", "[x", u.qf.xprev, { desc = "Goto previous qfloclist item" })
set("n", "]q", u.qf.cnext, { desc = "Goto next qflist" })
set("n", "[q", u.qf.cprev, { desc = "Goto previous qflist" })
set("n", "]l", u.qf.lnext, { desc = "Goto next loclist" })
set("n", "[l", u.qf.lprev, { desc = "Goto previous loclist" })
set("n", "<leader>xx", u.qf.toggle_workspace_diagnostic, { desc = "Workspace diagnostics" })
set("n", "<leader>xd", u.qf.toggle_buf_diagnostic,       { desc = "Buffer diagnostics" })
set("n", "<leader>xh", u.qf.toggle_info_diagnostic,      { desc = "Hint & Info diagnostics" })
set("n", "<leader>xc", u.qf.cclose,                      { desc = "Close qfloclist" })
set("n", "<leader>xq", vim.cmd.copen,                 { desc = "Open qflist" })
set("n", "<leader>xl", vim.cmd.lopen,                 { desc = "Open loclist" })

-- etc
set("n", "<leader>rg", [[<cmd>s!\v(https://)?(www\.)?github.com/([^/]+/[^/]+).*(")?!gh:\3\4<cr><cmd>noh<cr>]],                { desc = "Clean GitHub url (gh)" })
set("n", "<leader>rG", [[<cmd>s!\v(https://)?(www\.)?(github\.com/[^/]+/[^/]+).*(")?!\1\2\3\4!<cr><cmd>noh<cr>]],          { desc = "Clean GitHub url" })
set("n", "<leader>rc", [[<cmd>s!\v(https://)?(www\.)?codeberg.org/([^/]+/[^/]+).*(")?!cb:\3\4<cr><cmd>noh<cr>]],                { desc = "Clean GitHub url (gh)" })
set("n", "<leader>rC", [[<cmd>s!\v(https://)?(www\.)?(codeberg\.ord)/[^/]+/[^/]+).*(")?!\1\2\3\4!<cr><cmd>noh<cr>]],          { desc = "Clean GitHub url" })
