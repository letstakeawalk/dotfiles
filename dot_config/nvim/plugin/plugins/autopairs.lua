...
--     if cursor == nil or cursor < 1 then return true end
--
--     local balance = 0
...
--         if not cursor_at_eol then return "" end
--
...
--         if
--             vim.trim(nextline_first_nonblank) == ""
--             and vim.trim(nextnextline_first_nonblank) == close
--         then
...
--             if match == nil or vim.trim(match) == "" then return false end
...
--             if not line:sub(1, col - 1):match("[%w:<]+$") then return false end
...
--         end)
--         :with_cr(conds.none())
--         :with_move(function(opts) return opts.char == opts.next_char end),
-- })
--
...
--         :with_del(
--             function(opts) return opts.line:sub(opts.col - #close, opts.col - 1) ~= close end
--         )
--         :with_cr(conds.none())
...
--
-- -- Delete pair at once
-- -- TODO: `(  )|` delete should delete the pair.
