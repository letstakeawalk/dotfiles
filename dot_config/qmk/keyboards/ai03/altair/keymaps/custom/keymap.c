...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        QK_GESC, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    ONEPW,   /**/  MO(_FN), KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    ONEPW,
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    XXXXXXX, /**/  KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                                   KC_LALT, KC_LCMD, MO(_SYM),NUM_SPC, /**/  KC_ENT,  KC_SPC,  KC_BSPC, KC_HYPR
    ),
    [_SYM] = LAYOUT(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, /**/  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        KC_TAB,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, /**/  XXXXXXX, KC_ASTR, KC_LCBR, KC_RCBR, KC_PLUS, KK_COLN, KC_BSPC,
        KC_CAPS, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    XXXXXXX, /**/  XXXXXXX, KC_UNDS, KC_LPRN, KC_RPRN, KC_EQL,  KC_MINS, KC_DQUO,
        KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    XXXXXXX, /**/  XXXXXXX, KC_LBRC, KC_RBRC, KC_LT,   KC_GT,   KC_QUES, KC_RSFT,
                                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, /**/  KC_ENT,  KC_SPC,  KC_BSPC, XXXXXXX
    ),
    [_NUM] = LAYOUT(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, /**/  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    XXXXXXX, /**/  XXXXXXX, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    XXXXXXX,
        _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  XXXXXXX, XXXXXXX, /**/  XXXXXXX, XXXXXXX, KC_4,    KC_5,    KC_6,    KC_MINS, KC_PLUS,
        XXXXXXX, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, XXXXXXX, XXXXXXX, /**/  XXXXXXX, XXXXXXX, KC_1,    KC_2,    KC_3,    KC_SLSH, KC_ASTR,
