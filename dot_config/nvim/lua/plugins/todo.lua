        ...
        config = function()
            require("todo-comments").setup({
                ...
                highlight = {
                    ...
                    pattern = [[.*<(KEYWORDS)\s*(\(#\d+\)|\(\@\w+\))?:]], -- pattern or table of patterns, used for highlightng (vim regex)
                ...
                search = {
                    ...
                    pattern = [[\b(KEYWORDS)\s*(\(#\d+\)|\(@\w+\))?:]], -- ripgrep regex
                },
            })
        end,
    },
...
-- TODO(#10): add suffix attr then PR
