return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>cs", suggestion.toggle_auto_trigger, { desc = "Copilot Suggestion Toggle" })
        ...
        vim.keymap.set("i", "<C-e>", function()
            if suggestion.is_visible() then
                vim.notify("Copilot Suggestion: Disabled")
                suggestion.dismiss()
            else
        ...
        end, { desc = "Copilot Suggestion Toggle" })
