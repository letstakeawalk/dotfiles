...
1. Parse what the user wants remembered from `$ARGUMENTS` or the preceding conversation
2. Read the current MEMORY.md to check for duplicates or conflicts
3. **If the note conflicts with an existing memory, show both versions and ask the user to confirm before overwriting**
