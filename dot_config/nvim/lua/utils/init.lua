...
--- Command-mode: smart cursor nav to next word
...
--- Command-mode: smart cursor nav to prev word
...
M.move_pair = require("nvim-treesitter.textobjects.repeatable_move").make_repeatable_move_pair
...
M.cnext, M.cprev = M.move_pair(with_warning(vim.cmd.cnext), with_warning(vim.cmd.cprevious))
M.lnext, M.lprev = M.move_pair(with_warning(vim.cmd.lnext), with_warning(vim.cmd.lprevious))
function M.xnext()
...
function M.toggle_buf_diagnostic()
    M.cclose()
...
function M.toggle_workspace_diagnostic()
    M.cclose()
...
function M.toggle_info_diagnostic()
    M.cclose()
    vim.diagnostic.setqflist({
