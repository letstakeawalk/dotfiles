...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUM] = LAYOUT_all(
    ...
    MO(_C),    KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_NO,   KC_NO,   KC_4,     KC_5,    KC_6,    KC_NO,    KC_NO,   KC_ENT,                   KC_NO,
    KC_NO,     KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_NO,   KC_1,    KC_2,     KC_3,    KC_DOT,  HYP_SLSH, KC_RSFT,                  KC_UP,   KC_NO,
    KC_NO,     KC_NO,   KC_LCMD,          KC_TRNS,          KC_0,              KC_NO,   KC_NO,   KC_NO,                     KC_LEFT, KC_DOWN, KC_RIGHT
  ),
  ...
  [_C] = LAYOUT_all(
    KC_NO,     KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,   KC_NO,   S(KC_P),  KC_NO,   KC_NO,  KC_NO,            KC_NO,
  ...
  // for devices without Karabiner application.
  [_COLEMAK] = LAYOUT_all(
  ...
  [_CODE] = LAYOUT_all(
    ...
    KC_NO,     C(KC_Z), C(KC_X), C(KC_C), C(KC_D), C(KC_V), KC_LBRC, KC_RBRC,  KC_LT,   KC_GT,   KC_QUES,  KC_NO,                    KC_UP,   KC_NO,
