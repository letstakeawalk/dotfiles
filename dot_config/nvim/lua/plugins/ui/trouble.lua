return {
    ...
    keys = {
        ...
        { "]x", function() require("trouble").next({ skip_groups = true, jump = true }) end, desc = "Next item" },
        { "[x", function() require("trouble").previous({ skip_groups = true, jump = true }) end, desc = "Previous item" },
        ...
        vim.keymap.set("n", "T", "<cmd>Trouble lsp_type_definitions<cr>", { desc = "LSP TypeDefinition" }),
    },
