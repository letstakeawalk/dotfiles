...
local function editor()
    ...
    vim.api.nvim_set_hl(0, "Folded",       { fg = nord.c03_gry, bg = nord.cursorline })
    ...
    vim.api.nvim_set_hl(0, "WinSeparator", { fg = nord.c02_gry })
    -- Spell
    ...
    -- Search
    vim.api.nvim_set_hl(0, "CurSearch",   { fg = nord.c06_wht, bg = nord.c10_blue })
    ...
    -- TabLine
    vim.api.nvim_set_hl(0, "Tabline",       { fg = nord.fg })
    vim.api.nvim_set_hl(0, "TabLineFill",   { fg = nord.fg })
    vim.api.nvim_set_hl(0, "TablineSel",    { fg = nord.c08_teal })
    -- WindowBar
    -- vim.api.nvim_set_hl(0, "WinBar",   { fg = nord.fg })
    -- vim.api.nvim_set_hl(0, "WinBarNC",   { fg = nord.fg })
    -- Window
...
local function treesitter()
    ...
    -- git
    vim.api.nvim_set_hl(0, "@string.special.url.gitcommit", { fg = nord.c04_wht_dk})
    vim.api.nvim_set_hl(0, "@keyword.gitcommit", { fg = nord.c09_glcr, bold = true})
...
local function markdown()
    ...
    vim.api.nvim_set_hl(0, "@markup.heading.1.marker", { fg = nord.c09_glcr })
    vim.api.nvim_set_hl(0, "@markup.heading.2.marker", { fg = nord.c09_glcr })
    vim.api.nvim_set_hl(0, "@markup.heading.3.marker", { fg = nord.c09_glcr })
    vim.api.nvim_set_hl(0, "@markup.heading.4.marker", { fg = nord.c09_glcr })
    vim.api.nvim_set_hl(0, "@markup.heading.5.marker", { fg = nord.c09_glcr })
    vim.api.nvim_set_hl(0, "@markup.heading.6.marker", { fg = nord.c09_glcr })
    vim.api.nvim_set_hl(0, "@markup.heading.1", { fg = nord.c08_teal, bold = true})
    vim.api.nvim_set_hl(0, "@markup.heading.2", { fg = nord.c08_teal, bold = true})
    vim.api.nvim_set_hl(0, "@markup.heading.3", { fg = nord.c08_teal, bold = true})
    vim.api.nvim_set_hl(0, "@markup.heading.4", { fg = nord.c08_teal, bold = true})
    vim.api.nvim_set_hl(0, "@markup.heading.5", { fg = nord.c08_teal, bold = true})
