return {
    ...
    keys = {
        ...
        { "<leader>qh", "<cmd>BWipeout hidden<cr>", desc = "Close hidden buffers" },
        { "<leader>qu", "<cmd>BWipeout nameless<cr>", desc = "Close namless buffers" },
    },
    opts = {
        ...
        next_buffer_cmd = function()
            local bufs = vim.tbl_filter(function(buf)
                return vim.bo[buf.bufnr].buftype == "" -- normal buffers only
